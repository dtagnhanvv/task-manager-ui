(function () {
    ...
    angular
        .module('biddy.sale')
        .controller('SaleLayoutHeader', SaleLayoutHeader)
    ;

    function SaleLayoutHeader($scope, $rootScope, autoLogin, PROFILE_DEFAULT, sessionStorage) {
        $scope.formData = {
            PROFILE_DEFAULT: PROFILE_DEFAULT,
            avatarUrl: sessionStorage.getAvatarUrl() || null,
            unreadAlert: null
        };
