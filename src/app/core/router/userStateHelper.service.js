(function () {
    ...
    function userStateHelper($stateProvider, BASE_USER_STATES) {
         ...
         * app.admin.tagManagement and app.account.tagManagement
         *
            ...
            return {
                ...
                getBaseState: function () {
                    ...
                    if (Auth.isAuthorized(USER_ROLES.admin)) {
                        ...
                        baseState = BASE_USER_STATES.sale;
                    } else if (Auth.isAuthorized(USER_ROLES.account)) {
                        baseState = BASE_USER_STATES.account;
                    } else if (Auth.isAuthorized(USER_ROLES.subAccount)) {
                        baseState = BASE_USER_STATES.subAccount;
                    }
